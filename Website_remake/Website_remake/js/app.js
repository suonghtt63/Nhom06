/*js cho mega dropdown khi hover vào*/
...
//js khi mở trang web trên điện thoại
...
document.querySelector('#view-all-description').addEventListener('click', () => {
    ...
    document.querySelector('#view-all-description').innerHTML = content.classList.contains('active') ? 'Rút gọn' : 'Xem thêm'
})
