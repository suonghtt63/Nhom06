...
let products = [
    {
        name: 'Son Kem Lì Không K...',
        image1: './images/spnb1-1.png',
        image2: './images/spnb1-2.png',
        curr_price: '230.000 đ',
        old_price: '280.000 đ'
    },
    {
        name: 'Phấn Mắt Nhũ ARITA...',
        image1: './images/spnb2-1.png',
        image2: './images/spnb2-2.png',
        curr_price: '99.000 đ',
        old_price: '130.000 đ'
    },
    {
        name: 'Kem Đánh Răng 100%...',
        image1: './images/spnb3-1.png',
        image2: './images/spnb3-2.png',
...
let product_list_best = document.querySelector('#best-product')
...
products.forEach(e => {
    ...
    product_list_best.insertAdjacentHTML("beforeend", prod)
})